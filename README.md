...
```bash
git clone https://github.com/mariegrace31/budgetBuddy.git
```
...
Feel free to check the [issues page](https://github.com/mariegrace31/budgetBuddy/issues).
...
If you find this project helpful or interesting, star ⭐️ this repository on GitHub to let me know you like the project.
